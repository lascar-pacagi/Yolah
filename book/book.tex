...
La fonction \mintinline{c++}{shift(uint64_t b)} donnée dans le listing \ref{lst:shift} nous permet de décaler tous les bits à 1 du bitboard en paramètre dans la direction \mintinline{c++}{D}. Soit,
...
La consultation de cette table de hachage est bien plus coûteuse que l'indexation d'un simple tableau \footnote{Nous mesurerons à la fin de cette section le gain apporté par le hachage parfait par rapport à l'utilisation d'une table de hachage classique.}
