...
% Dans le prochain chapitre, nous allons étudier l'implémentation du jeu Yolah, cette implémentation se veut efficace car il sera important pour les IA de pouvoir jouer beaucoup de parties à la seconde~; leur niveau de jeu va en dépendre.

In the next chapter, we will study the implementation of the Yolah game. This implementation is designed to be efficient because it will be important for the AIs to be able to play many games per second; their level of play will depend on it.\\
