...
Nous allons implémenter la gestion du jeu en C++ en essayant de créer une implémentation efficace pour pouvoir réaliser un maximum de parties à la seconde, ce qui sera important pour avoir des IA de bons niveaux. Nous testerons notre implémentation en générant un maximum de parties aléatoires en un temps donné à la fin de ce chapitre.\\
...
Prenons comme exemple le plateau représentée dans la figure \ref{fig:yolah_game_engine1}. Les positions des pièces noires sur le plateau~:\\


seront représentées par le bitboard suivant~:\\
