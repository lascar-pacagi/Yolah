...
\vspace*{\fill}
\begin{center}
\textit{À Sar\textbf{ah}, Hug\textbf{o} et C\'e\textbf{ly}a \textcolor{red}{\faHeart}}\\
\textit{\textbf{ah o ly}}\\
\textit{\textbf{yolah}}\\
\textit{\textbf{Yolah}}
\end{center}
...
\caption{Board position example (after move 23 in figure \ref{fig:fig:game_example_middle})}
...
\begin{tabular}{|c|c|c|c|c|c|c|c|c|}
\hline
8 & $\times$ & $\bullet$ & $\cdot$ & $\cdot$ & $\times$ & $\cdot$ & $\cdot$ & $\times$ \\ \hline
7 & $\cdot$ & $\cdot$ & $\cdot$ & $\cdot$ & $\cdot$ & $\circ$ & $\cdot$ & $\bullet$ \\ \hline
6 & $\bullet$ & $\cdot$ & $\circ$ & $\times$ & $\times$ & $\times$ & $\cdot$ & $\cdot$ \\ \hline
5 & $\cdot$ & $\textcolor{red}{\boldsymbol{\ast}}$ & $\cdot$ & $\times$ & $\times$ & $\times$ & $\times$ & $\times$ \\ \hline
4 & $\cdot$ & $\cdot$ & $\textcolor{red}{\boldsymbol{\ast}}$ & $\times$ & $\times$ & $\times$ & $\times$ & $\cdot$ \\ \hline
3 & $\times$ & $\textcolor{red}{\boldsymbol{\ast}}$ & $\textcolor{red}{\boldsymbol{\ast}}$ & $\circ$ & $\textcolor{red}{\boldsymbol{\ast}}$ & $\times$ & $\cdot$ & $\cdot$ \\ \hline
2 & $\times$ & $\times$ & $\textcolor{red}{\boldsymbol{\ast}}$ & $\times$ & $\textcolor{red}{\boldsymbol{\ast}}$ & $\circ$ & $\cdot$ & $\bullet$ \\ \hline
1 & $\times$ & $\textcolor{red}{\boldsymbol{\ast}}$ & $\cdot$ & $\cdot$ & $\cdot$ & $\textcolor{red}{\boldsymbol{\ast}}$ & $\times$ & $\times$ \\ \hline
\multicolumn{1}{c|}{} & a & b & c & d & e & f & g & h \\
\cline{2-9}
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Bitboard of possible moves for white piece at d3}
...
\begin{table}[H]
\centering
\caption{Mask for horizontal, vertical and diagonal moves from d3}
...
3 & \begin{tabular}{@{}c@{}}{\tiny 16}\\[1pt]\textbf{1}\end{tabular} & \begin{tabular}{@{}c@{}}{\tiny 17}\\[1pt]\textbf{1}\end{tabular} & \begin{tabular}{@{}c@{}}{\tiny 18}\\[1pt]\textbf{1}\end{tabular} & \cellcolor{lightgray}\begin{tabular}{@{}c@{}}{\tiny 19}\\[1pt]\textbf{1}\end{tabular} & \begin{tabular}{@{}c@{}}{\tiny 20}\\[1pt]\textbf{1}\end{tabular} & \begin{tabular}{@{}c@{}}{\tiny 21}\\[1pt]\textbf{1}\end{tabular} & \begin{tabular}{@{}c@{}}{\tiny 22}\\[1pt]\textbf{1}\end{tabular} & \begin{tabular}{@{}c@{}}{\tiny 23}\\[1pt]\textbf{1}\end{tabular} \\[5pt] \hline
...
3 & \begin{tabular}{@{}c@{}}{\tiny 16}\\[1pt]\textbf{1}\end{tabular} & \begin{tabular}{@{}c@{}}{\tiny 17}\\[1pt]0\end{tabular} & \begin{tabular}{@{}c@{}}{\tiny 18}\\[1pt]0\end{tabular} & \cellcolor{lightgray}\begin{tabular}{@{}c@{}}{\tiny 19}\\[1pt]\textbf{1}\end{tabular} & \begin{tabular}{@{}c@{}}{\tiny 20}\\[1pt]0\end{tabular} & \begin{tabular}{@{}c@{}}{\tiny 21}\\[1pt]\textbf{1}\end{tabular} & \begin{tabular}{@{}c@{}}{\tiny 22}\\[1pt]0\end{tabular} & \begin{tabular}{@{}c@{}}{\tiny 23}\\[1pt]0\end{tabular} \\[5pt] \hline
