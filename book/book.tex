...
\title{
    ...
    \vspace{0.5cm}
    \huge Building a Two-Player Perfect-Information Game with Artificial Players\\
}
...
La nouvelle version de la fonction \mintinline{c++}{moves} du listing \ref{lst:random_games_perf2} avec la boucle \mintinline{c++}{while (bb)} déroulée (ligne 5), est donné dans le listing \ref{lst:random_games_perf3}.
\begin{itemize}
...
\item Aux lignes 16 à 18, nous créons les coups pour la pièce situé dans la case \mintinline{c++}{from0}.
\item Aux lignes 19 à 21, nous créons les coups pour la pièce situé dans la case \mintinline{c++}{from1}.
\item Aux lignes 22 à 24, nous créons les coups pour la pièce situé dans la case \mintinline{c++}{from2}.
\item Aux lignes 25 à 27, nous créons les coups pour la pièce situé dans la case \mintinline{c++}{from3}.
\end{itemize}
