#ifndef MINMAX_PLAYER_V3_H
#define MINMAX_PLAYER_V3_H
#include "player.h"
#include "heuristic.h"
#include "transposition_table.h"
#include <atomic>

class MinMaxPlayerV3 : public Player {
...
public:
    MinMaxPlayerV3(uint64_t microseconds, size_t tt_size_mb, size_t nb_moves_at_full_depth, uint8_t late_move_reduction, 
