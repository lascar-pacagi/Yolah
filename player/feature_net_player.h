#ifndef FEATURE_NET_PLAYER_H
#define FEATURE_NET_PLAYER_H
#include "player.h"
...
class FeatureNetPlayer : public Player {
...
public:
    FeatureNetPlayer(uint64_t microseconds, size_t tt_size_mb, size_t nb_moves_at_full_depth, uint8_t late_move_reduction, 
