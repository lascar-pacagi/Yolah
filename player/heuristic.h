...
namespace heuristic {
    ...
    */
    ...
    constexpr std::array<double, NB_WEIGHTS> WEIGHTS{-261.299, 105.4702532154874, -48.32193088939683, 115.9949267398348, 195.8689144128958, -354.2752260588214, 360.3292424090679};
