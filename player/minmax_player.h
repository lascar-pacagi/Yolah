...
class MinMaxPlayer : public Player {
    ...
    int16_t quiescence(Yolah& yolah, Search&, int16_t alpha, int16_t beta, int8_t depth);
...
public:
    MinMaxPlayer(uint64_t microseconds, size_t tt_size_mb, size_t nb_moves_at_full_depth, uint8_t late_move_reduction, 
