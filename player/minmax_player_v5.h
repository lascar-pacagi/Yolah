#ifndef MINMAX_PLAYER_V5_H
#define MINMAX_PLAYER_V5_H
#include "player.h"
#include "heuristic.h"
#include "transposition_table.h"
#include <atomic>

class MinMaxPlayerV5 : public Player {
...
public:
    MinMaxPlayerV5(uint64_t microseconds, size_t tt_size_mb, size_t nb_moves_at_full_depth, uint8_t late_move_reduction, 
