#ifndef MINMAX_PLAYER_V7_H
#define MINMAX_PLAYER_V7_H
#include "player.h"
#include "heuristic.h"
#include "transposition_table.h"
#include <atomic>

class MinMaxPlayerV7 : public Player {
    ...
    size_t nb_nodes = 0;
    size_t nb_hits  = 0;
    static constexpr int16_t HISTORY_MAX = 30000;
...
public:
    MinMaxPlayerV7(uint64_t microseconds, size_t tt_size_mb, size_t nb_moves_at_full_depth, uint8_t late_move_reduction, 
