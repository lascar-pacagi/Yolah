...
int main(int argc, char* argv[]) {
    ...
    //test::tournament({"/Yolah/config/random_player.cfg", "/Yolah/config/mc_player.cfg", "/Yolah/config/mcts_player.cfg", "/Yolah/config/mm_player.cfg", "/Yolah/config/mm_nnue_quantized_player.cfg"}, 4, 2000);
