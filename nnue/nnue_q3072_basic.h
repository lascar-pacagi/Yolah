#ifndef NNUE_Q3072_BASIC_H
#define NNUE_Q3072_BASIC_H
#include <cstddef>
#include <vector>
#include <tuple>
#include "game.h"
...
struct NNUE_Q3072_BASIC {  
    ...
    alignas(64) int32_t h1_bias[H1_SIZE];
    alignas(64) int16_t input_to_h1[INPUT_SIZE * H1_SIZE];
    alignas(64) int32_t h2_bias[H2_SIZE];
    alignas(64) int16_t h1_to_h2[H1_SIZE * H2_SIZE];
    alignas(64) int32_t h3_bias[H3_SIZE];
    alignas(64) int16_t h2_to_h3[H1_SIZE * H2_SIZE];
    alignas(64) int32_t output_bias[OUTPUT_SIZE + 1]{};
    alignas(64) int16_t h3_to_output[H3_SIZE * OUTPUT_SIZE];
    struct Accumulator {
        int32_t* acc;
        Accumulator() {
            acc = (int32_t*)aligned_alloc(64, 4 * H1_SIZE);
